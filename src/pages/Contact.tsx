...
export default function Contact() {
  useEffect(() => {
    updatePageSEO({
      title: 'Contact India\'s Leading Dental Website Developers | Zera Dental',
      description: 'Get in touch with Zera Dental. Hire the best specialized school of web development for dental clinics. Phone support at +91 9835102324 or request a proposal.',
      keywords: 'contact dental website designer, hire dentist web developer Mumbai, dental SEO agency Delhi Pune, dental clinical marketing phone number India, Zera Dental support',
      ogUrl: 'https://zeradental.in#contact',
      schemaId: 'contact-page-schema',
      schemaData: {
        '@context': 'https://schema.org',
        '@type': 'ContactPage',
        'name': 'Contact Zera Dental Agency',
        'description': 'Direct inquiry portal to consult specialized web design partners for dental clinics in India.',
        'url': 'https://zeradental.in#contact',
        'mainEntity': {
          '@type': 'LocalBusiness',
          'name': 'Zera Dental',
